%..Saltos de retorno
%..número de saltos grandes (mayores o iguales a 8 semitonos) que no estan
%seguidos por un intervalo de retorno (mínimo 1 semitono menor que el intervalo precedente)

%P=[2 4 4 5 7 8 7 9 9 9 12 0 9 9 9 8 7 6 4 3];
%P=[2 3 2 3 2 3 2 3 4 3 1 2 3 4 3 2 1];
%P=[2 2 2 11 3 2 2];

function Sr = saltosderetorno(nmat);
...
Sr = (n-ilsr)/n; % a mayor número de intervalos de retorno, Sr es menor a 1.
%................................
