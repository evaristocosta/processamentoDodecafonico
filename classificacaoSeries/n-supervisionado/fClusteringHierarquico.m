...
function [VetorClasseSaida,Z,c,I,Te] = fClusteringHierarquico(X,Nc,Mdistancia,Magrupamento,OpGraficar)
...
if OpGraficar==1
    if Nc>1
        and = ' and  ';
        name = strcat(Mdistancia, and, Magrupamento);
